...
public class TinyPiEParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, ADDOP=3, MULOP=4, ANDOP=5, OROP=6, MINUSOP=7, IDENTIFIER=8, 
		VALUE=9, WS=10;
	public static final int
	...
	private static final String[] _SYMBOLIC_NAMES = {
		null, null, null, "ADDOP", "MULOP", "ANDOP", "OROP", "MINUSOP", "IDENTIFIER", 
		"VALUE", "WS"
	};
	...
	public static class UnExprContext extends UnaryExprContext {
		public TerminalNode MINUSOP() { return getToken(TinyPiEParser.MINUSOP, 0); }
		public UnaryExprContext unaryExpr() {
			return getRuleContext(UnaryExprContext.class,0);
		}
